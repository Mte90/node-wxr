...
module.exports = Importer = (function() {
  ...
  Importer.prototype.addPost = function(post) {
    var cat, catCDATA, category, contentEncoded, contentEncodedCDATA, creator, date, description, excerptEncoded, excerptEncodedCDATA, i, item, len, name, parent, ref, ref1, results, status, title, type, id, postmeta;
    item = this.channel.ele("item");
    title = item.ele("title", {}, post.title ? post.title : "");
    name = item.ele("wp:post_name", {}, post.name ? post.name : "");
    id = item.ele("wp:post_id", {}, post.id ? post.id : "");
    ...
    if (((ref = post.categories) != null ? ref.length : void 0) > 0) {
     ...
     if (((ref2 = post.tags) != null ? ref2.length : void 0) > 0) {
        ref3 = post.tags;
        results = [];
        for (j = 0, len1 = ref3.length; j < len1; j++) {
          ...
          if (tag.slug && tag.title) {
            ...
            results.push(tagCDATA = tg.dat(tag.title));
          } else {
            results.push(void 0);
          }
        }
  ...
  Importer.prototype.addAttachment = function(options) {
    var creator, date, description, excerptEncoded, excerptEncodedCDATA, contentEncoded, contentEncodedCDATA, item, parent, status, title, type, id;
    if (options.attachmentURL) {
      ...
      item.ele("guid", {'isPermalink':false},  options.attachmentURL ?  options.attachmentURL : 0);
