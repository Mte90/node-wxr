(function() {
  ...
  module.exports = Importer = (function() {
    ...
    Importer.prototype.addPost = function(post) {
      var cat, catCDATA, category, contentEncoded, contentEncodedCDATA, creator, date, description, excerptEncoded, excerptEncodedCDATA, i, item, j, len, len1, name, parent, ref, ref1, ref2, ref3, results, status, tag, tagCDATA, tg, title, type, id;
